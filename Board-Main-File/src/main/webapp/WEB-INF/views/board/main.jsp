...
<div style="margin: 15%">
	...
	<div class="col-lg-12" id="modifyPage" style="padding: 0px;">
		...
		<form name="frr" role="form" onSubmit="return Checkform()"
			...
			<input class="form-control" placeholder="ID" id='bno2' style='margin-bottom: 10px;' /> <input
				class="form-control" placeholder="Password" id='bno2' style='margin-bottom: 10px;'/>
				<a id='userRegister' style="float:right;">회원 가입</a>
			<div id="but" style="margin-top: 10px;">
				<button type="button" onclick="return updateData()"
					style="margin-top: 10px; text-align: center; padding: 0; width: 100%; border-radius: 20px; padding: 10px;"
					class="btn btn-sm btn-primary">로그인</button>
			</div>
		</form>
	</div>
