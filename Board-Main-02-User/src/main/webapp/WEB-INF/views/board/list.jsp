			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="margin-bottom: 10px">
						<div style='display:inline;'>Board List Page</div>
						<button class="btn_N"
					...
					<div id='logoutBtn'
						style="float: left; padding-bottom: 5px; padding-left: 16px; font-weight: bold;">계정 : ${userName}</div>
					<div id='TotalPage'
						style="float: right; padding-bottom: 5px; padding-right: 16px; font-weight: bold;"></div>
		...
		BoardService
				.getList(
						...
						function(list) {
							...
							strrr += "<div class='Total' style='display: inline;'>총 게시물 개수는 : "
									+ list.ListData.total + "</div>";

							var name = '${userAuth}'

							if (name != '[ROLE_USER]') {
								strrr += "<button onclick='OnDelBtn()' style='border: none;'>X</button>"
							}

							BoardTotal.html(strrr)
